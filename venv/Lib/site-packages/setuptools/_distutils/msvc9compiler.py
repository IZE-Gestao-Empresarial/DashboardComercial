...
if NATIVE_WIN64:
    ...
    WINSDR_BASE = r"Software\Wow6432Node\Microsoft\Microsoft SDRs\Windows"
    NET_BASE = r"Software\Wow6432Node\Microsoft\.NETFramework"
else:
    VS_BASE = r"Software\Microsoft\VisualStudio\%0.1f"
    WINSDR_BASE = r"Software\Microsoft\Microsoft SDRs\Windows"
...
class MacroExpander:
    ...
    def load_macros(self, version):
        ...
        try:
            if version >= 8.0:
                self.set_macro("FrameworkSDRDir", NET_BASE, "SDRinstallrootv2.0")
            else:
                raise KeyError("SDRinstallrootv2.0")
        except KeyError:
...
you can try compiling with MingW32, by passing "-c mingw32" to setup.py."""
        ...
        if version >= 9.0:
            ...
            self.set_macro("WindowsSDRDir", WINSDR_BASE, "currentinstallfolder")
        else:
...
class MSVCCompiler(CCompiler):
    ...
    def initialize(self, plat_name=None):  # noqa: C901
        ...
        if (
            "DISTUTILS_USE_SDR" in os.environ
            and "MSSDR" in os.environ
            and self.find_exe("cl.exe")
        ):
            # Assume that the SDR set up everything alright; don't try to be
            # smarter
            self.cc = "cl.exe"
