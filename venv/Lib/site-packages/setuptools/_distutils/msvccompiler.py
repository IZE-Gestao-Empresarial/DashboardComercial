...
class MacroExpander:
    ...
    def load_macros(self, version):
        ...
        try:
            if version > 7.0:
                self.set_macro("FrameworkSDRDir", net, "SDRinstallrootv1.1")
            else:
                self.set_macro("FrameworkSDRDir", net, "SDRinstallroot")
        except KeyError:
...
class MSVCCompiler(CCompiler):
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        if self.__arch == "Intel":
            ...
            # Win64. Assume this was built with the platform SDR
            self.__product = "Microsoft SDR compiler %s" % (self.__version + 6)
