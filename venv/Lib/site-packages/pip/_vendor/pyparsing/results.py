...
class ParseResults:
    ...
    def as_list(self) -> list:
        ...
        Example::
            ...
            patt = Word(alphas)[1, ...]
            result = patt.parse_string("sldkj lSDRj sldkj")
            # even though the result prints in string-like form, it is actually a pyparsing ParseResults
            print(type(result), result) # -> <class 'pyparsing.ParseResults'> ['sldkj', 'lSDRj', 'sldkj']

            # Use as_list() to create an actual list
            result_list = result.as_list()
            print(type(result_list), result_list) # -> <class 'list'> ['sldkj', 'lSDRj', 'sldkj']
        """
        return [
